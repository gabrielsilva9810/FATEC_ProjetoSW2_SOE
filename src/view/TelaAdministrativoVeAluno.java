...
public class TelaAdministrativoVeAluno extends JFrame {	
...
// ============================================================ TELA BASE =============================================================
// ====================================================================================================================================
	public TelaAdministrativoVeAluno() {	
...
// ====================================================================================================================================
				...
				separator_4.setBounds(245, 217, 709, 2);
				tabPerfil.add(separator_4);
				
				JComboBox comboBox = new JComboBox();
				comboBox.setModel(new DefaultComboBoxModel(new String[] {"Ativo", "Trancado", "Desistente"}));
				comboBox.setBounds(435, 152, 95, 22);
				tabPerfil.add(comboBox);
				
				btnGravar_1 = new JButton("Gravar");
				btnGravar_1.setBounds(840, 179, 110, 32);
				...
				lblStatus_3 = new JLabel("Autorizou divulgar");
				lblStatus_3.setBounds(813, 434, 95, 25);
				tabGrupo.add(lblStatus_3);
				
				textField_2 = new JTextField();
				textField_2.setColumns(10);
				textField_2.setBounds(905, 434, 54, 20);
				tabGrupo.add(textField_2);
				
				textField_4 = new JTextField();
				textField_4.setColumns(10);
				textField_4.setBounds(573, 405, 123, 20);
