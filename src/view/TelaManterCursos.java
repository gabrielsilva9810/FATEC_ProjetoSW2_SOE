...
//====================================================================================================================================
	public TelaManterCursos() {
		...
		Nome = new JTextField();
		Nome.setBounds(197, 199, 269, 20);
		contentPane.add(Nome);
		Nome.setColumns(10);
		
		JLabel lblNome = new JLabel("Curso");
		lblNome.setBounds(197, 183, 40, 17);
		contentPane.add(lblNome);
		
		JLabel lbTelefone = new JLabel("Limite de Ciclos");
		lbTelefone.setBounds(196, 273, 110, 17);
		...
		btnGravar.setBounds(546, 364, 110, 32);
		contentPane.add(btnGravar);
		
		List list = new List();
		list.setBounds(197, 296, 269, 32);
		contentPane.add(list);
		
		List list_1 = new List();
		list_1.setBounds(546, 199, 269, 32);
		contentPane.add(list_1);
		
		JLabel lblDescrio = new JLabel("Descrição");
		lblDescrio.setBounds(546, 183, 110, 17);
		contentPane.add(lblDescrio);
		
		JLabel lblPerodo = new JLabel("Período");
		lblPerodo.setBounds(546, 284, 110, 17);
		contentPane.add(lblPerodo);
		
		List list_2 = new List();
		list_2.setBounds(546, 306, 269, 32);
